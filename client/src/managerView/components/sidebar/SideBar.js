...
export default function Sidebar() {
  ...
  grabSVG(employeeIcon).then(eyqxf => {
      employeeIconSVG = eyqxf;
      document.querySelector(".employee_icon_svg").innerHTML = employeeIconSVG
  })

  grabSVG(restaurantIcon).then(eyqxf => {
      restaurantsIconSVG = eyqxf;
      document.querySelector(".restaurants_icon_svg").innerHTML = restaurantsIconSVG
  })
      ...
      <div className="sb_tr">
        <div className="sidebar_list">
          <ul className="sidebar_list_top">
            ...
            {/*----- EMPLOYEE LINK -----*/}
            <li className="sb_employee_link">
              <Link to="/employee" className="row" onClick={handle}>
                <div className="svg_holder">
                  <div className="employee_icon_svg"></div>
                </div>            
                <span>Employee</span>
              </Link>
            </li>
            ...
            {/*----- RESTAURANTS LINK -----*/}
            <li className="sb_restaurants_link">
              <Link to="/restaurants" className="row" onClick={handle}>
                <div className="svg_holder">
                  <div className="restaurants_icon_svg"></div>
                </div>            
